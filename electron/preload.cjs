...
contextBridge.exposeInMainWorld('desktopAPI', Object.freeze({
  ...
  media: Object.freeze({
    create: options => ipcRenderer.invoke('media:create', options),
    ...
    seek: (id, seconds, operationId) => ipcRenderer.invoke('media:seek', id, seconds, operationId),
    step: (id, direction, operationId) => ipcRenderer.invoke('media:step', id, direction, operationId),
